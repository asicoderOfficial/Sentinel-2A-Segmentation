...
data_split_mode = config['train']['mode']['name']
            ...
            for curr_epoch in epochs:
                for curr_learning_rate in learning_rates:
                    try:
                        ...
                        if verbose:
                            logger.info(f'Running experiment with train percentage {curr_train_percentage}, split by {data_split_mode}, batch size {curr_batch_size}, epoch {curr_epoch} and learning rate {curr_learning_rate}.')
